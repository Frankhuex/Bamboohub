...
export default function Search() {
    ...
    return (<>
        ...
        <form onSubmit={() => fetchBooks()} className="flex mt-7 justify-center">
            ...
            <button onClick={() => fetchBooks()} className="btn btn-neutral rounded-l-none px-6 h-auto border-l-0" type="submit">
                搜索
            </button>
        </form>
        ...
        {type==="book" && books && books.length>0 && <BookFilterPage books={books} defaultClassifiedBy="roleType" defaultSortedBy="title" showSearchBox={false} />}
